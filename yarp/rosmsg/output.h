...
// Generated from the following "output" msg definition:
//   float64 timestamp
//   float64[] pose
//   float64[] velocity// Instances of this class can be read and written with YARP ports,
// using a ROS-compatible format.

#ifndef YARP_ROSMSG_output_h
#define YARP_ROSMSG_output_h
...
class output : public yarp::os::idl::WirePortable
{
public:
    ...
    typedef yarp::os::idl::BareStyle<yarp::rosmsg::output> rosStyle;
    typedef yarp::os::idl::BottleStyle<yarp::rosmsg::output> bottleStyle;

    // The name for this message, ROS will need this
    static constexpr const char* typeName = "output";
